...
def home():
    ...
    if request.method == "POST":
        ...
        if connection.is_connected():
            ...
            print("not connected")
        mySql_insert_query = "SELECT INFO_BOX_SPORTS.play_time, INFO_BOX_SPORTS.sport_location FROM   INFO_BOX_SPORTS WHERE  INFO_BOX_SPORTS.userName=%s AND INFO_BOX_SPORTS.play_time=%s AND INFO_BOX_SPORTS.sport_location=%s;"
        ...
        for x in myresult:
              print(x)
        connection.commit()                                                                      
        temp=[["NOTHING FOUND","YOUR SEARCH"]]
